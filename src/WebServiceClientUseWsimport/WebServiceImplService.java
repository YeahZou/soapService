 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://WebServiceSystem/", wsdlLocation = "http://localhost:1234/webService/webservicetest?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://WebServiceSystem/", "WebServiceImplService");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://WebServiceSystem/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebServiceSystem/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
